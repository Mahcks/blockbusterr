...
Use `ghcr.io/mahcks/blockbusterr:latest-beta` to follow beta updates, or pin the immutable `ghcr.io/mahcks/blockbusterr:v2.0.0-beta.5` image. The `latest` tag remains on stable v1 until v2 is released.
</Aside>
