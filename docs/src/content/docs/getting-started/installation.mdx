...
<Aside type="caution" title="Installing the v2 beta">
Use `ghcr.io/mahcks/blockbusterr:latest-beta` to follow beta updates, or pin an immutable version such as `ghcr.io/mahcks/blockbusterr:v2.0.0-beta.1`. The `latest` tag remains on the stable v1 release until v2 is ready.
</Aside>
