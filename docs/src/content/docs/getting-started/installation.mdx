...
Use `ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1` to test this release candidate. Stable `latest` remains on v1; `latest-beta` follows prereleases. Before upgrading from v1, back up the complete data directory and follow the [upgrade guide](/getting-started/upgrading-to-v2/).
</Aside>
...
1. Pull the latest image:
   ...
   ```bash
   docker pull ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1
   ```
...
1. Create `compose.yaml`:
   ...
   services:
     blockbusterr:
       image: ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1
