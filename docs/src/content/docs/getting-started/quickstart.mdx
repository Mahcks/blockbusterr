...
<CardGrid>
<Card title="Set Up Scoring" icon="star" href="/concepts/filters">
Configure how movies/shows are scored
</Card>
<Card title="Configure Filters" icon="setting" href="/concepts/filters">
Define what content to block or allow
</Card>
<Card title="Create Jobs" icon="rocket" href="/concepts/jobs">
...
1. Open your browser and navigate to `http://localhost:9090`
   ...
   ![Configuration Interface](../../../assets/settings.png)
...
- Learn about [different job types](/concepts/jobs/)
- Configure [advanced filters and scoring](/concepts/filters/)
- Set up [smart jobs](/concepts/smart-jobs/) for adaptive content discovery
