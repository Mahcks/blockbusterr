...
| Immutable release image | `ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1` |
...
2. Set the name to `blockbusterr` and the repository to `ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1`.
...
<Steps>
1. Open **Apps**, choose the option to install a custom app, and use `ghcr.io/mahcks/blockbusterr:v2.0.0-rc.1` as the image.
