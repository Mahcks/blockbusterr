...
func TestValidateDynamicJobSources(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "TMDB recommendations", job: config.DynamicJob{Name: "Because you watched", Type: "recommendations", Source: "tmdb", MediaType: "movie", Limit: 50, RecommendationSeeds: []int{550, 680}}},
		{name: "Recommendations need seeds", job: config.DynamicJob{Name: "Empty", Type: "recommendations", Source: "tmdb", MediaType: "movie", Limit: 50}, wantErr: true},
		{name: "Recommendations reject invalid seeds", job: config.DynamicJob{Name: "Invalid", Type: "recommendations", Source: "tmdb", MediaType: "show", Limit: 50, RecommendationSeeds: []int{0}}, wantErr: true},
		{name: "Recommendations accept seed list", job: config.DynamicJob{Name: "From list", Type: "recommendations", Source: "tmdb", MediaType: "movie", Limit: 50, RecommendationList: &config.RecommendationSeedList{Source: "tmdb", List: config.ListLocator{Kind: "public_list", ListID: "123"}}}},
		{name: "Anime series type", job: config.DynamicJob{Name: "Anime", Type: "popular", Source: "tmdb", MediaType: "show", Limit: 50, SeriesType: "anime"}},
		{name: "Movie series type", job: config.DynamicJob{Name: "Wrong", Type: "popular", Source: "tmdb", MediaType: "movie", Limit: 50, SeriesType: "anime"}, wantErr: true},
