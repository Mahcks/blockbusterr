...
func TestAssessReadiness(t *testing.T) {
	...
	t.Run("configured Letterboxd list job is ready", func(t *testing.T) {
		cfg := &config.Config{}
		...
		cfg.MigrateRuleSets()
		cfg.Jobs.List = []config.DynamicJob{{ID: "list", Name: "Letterboxd", Enabled: true, Type: string(enums.JobTypeList), Source: "letterboxd", MediaType: "movie", RuleSetID: config.DefaultMoviesRuleSetID}}
