...
var JobTemplates = []JobTemplate{
	...
	{ID: "personal-watchlist", Version: 1, Name: "Personal Watchlist", Description: "Sync your connected TMDB movie watchlist.", Type: string(enums.JobTypeList), MediaType: "movie", Source: "tmdb", Limit: 250, DeliveryLimit: 10, SyncInterval: "2h", Category: "Movies", RuleSetName: "Personal Watchlist Movies", List: &config.ListLocator{Kind: string(enums.ListKindWatchlist), Ordering: "source"}, Movies: &config.MovieFilters{}},
